...
class GeospatialAdmin {
	function __construct() {
		$this->bulk_importer = new GeospatialBulkImporter($this);
	...
	function _post_editor_setup() {
    	...
    	wp_enqueue_script('openlayers-editor-loader', GEOSPATIAL_URL . "js/openlayers/editor/loader.js");
    	wp_enqueue_script('openlayers-editor', GEOSPATIAL_URL . "js/openlayers/editor/Editor/Lang/en.js");
    	wp_enqueue_style('openlayers-editor-style', GEOSPATIAL_URL . "js/openlayers/editor/theme/geosilk/geosilk.css");
